...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\Dell\\Desktop\\Microsoft_Project1\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Dell\Desktop\Microsoft_Project1\Attendance(Manually)"'
                )
    ...
    SUB_ENTRY = tk.Entry(
        sb, width=20, bg="pink", fg="red", font=("times", 23, " bold ")
    )
